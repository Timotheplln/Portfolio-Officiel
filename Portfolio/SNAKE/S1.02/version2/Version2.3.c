...
int main(){
    ...
    char directionghost; // Indique dans quel direction le serpent fantome doit se diriger
    ...
    int deplacementghost[NB_GHOST]; // Déplacements du serpent fantome
    int ghostfinal; // Quel fantome prend le moins de déplacement
    ...
    bool portailatteint; // Indique si un poratil à été traversé
