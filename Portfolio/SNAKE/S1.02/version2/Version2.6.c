...
void portail(int portail, int pomme, int *deplacement, int portailD, int portailG, int portailH, int portailB, char direction);
...
int main(){
    ...
    char directionG; // Indique dans quel direction le serpent fantôme doit se diriger
    int lesYghost[TAILLE_MAX], lesXghost[TAILLE_MAX]; // Position de chaques parties du serpent fantôme
    int deplacementG[NB_GHOST]; // Combien de déplacement unitaire les serpents fantômes ont fait
    int portailG1[2]={MIN,(MAX_HAUT/2)-TAILLE_TROU}; // indique l'emplacement du portail de droite
    int portailD2[2]={MAX_LONG,(MAX_HAUT/2)-TAILLE_TROU}; // indique l'emplacement du portail de gauche
    int portailH3[2]={(MAX_LONG/2)-TAILLE_TROU,MIN}; // indique l'emplacement du portail du haut
    int portailB4[2]={(MAX_LONG/2)-TAILLE_TROU,MAX_HAUT}; // indique l'emplacement du portail du bas
    ...
    do{
        ...
        if(mangee==true){
            ...
            while((lesXghost[0]!=pomme[X_TAB])&&(lesYghost[0]!=pomme[Y_TAB])){
                if((directionghost==HAUT)||(directionghost==BAS)){ // Si le serpent avance vers la droite ou vers la gauche, il ne peut changer de direction que vers en bas ou vers en haut
                    if(pomme[X_TAB]<lesXghost[0]){ // Si la pomme est à gauche de la tête du serpent, le serpent va à gauche
                        directionghost=GAUCHE;
                    }else if(pomme[X_TAB]>lesXghost[0]){ // Si la pomme est à droite de la tête du serpent, le serpent va à droite
                        directionghost=DROITE;
                    }
                }else if((directionghost==GAUCHE)||(directionghost==DROITE)){ // Si le serpent avance vers le bas ou vers le haut, il ne peut changer de direction que vers la droite ou vers la gauche
            ...
            while((lesXghost[0]!=pomme[X_TAB])&&(lesYghost[0]!=pomme[Y_TAB])){
                ...
                progresserGhost(lesXghost,lesYghost,directionghost, taille, pomme);
                deplacementghost[1]++;
            }
            ...
            while((lesXghost[0]!=portail[X_TAB])&&(lesYghost[0]!=portail[Y_TAB])){
                ...
                progresserGhost(lesXghost,lesYghost,directionghost, taille, portail);
                deplacementghost[2]++;
            }
            lesXghost[0]-=2;
        ...
        /*
        ghostfinal=deplacementghost[0];
        for(i=1;i<NB_GHOST;i++){
            if(ghostfinal>deplacementghost[i]){
                ghostfinal=deplacementghost[i];
            }
        }
        if(ghostfinal==deplacementghost[0]){
            if((lesX[0]!=pomme[X_TAB])&&(lesY[0]!=pomme[Y_TAB])){
        ...
        }else if(ghostfinal==deplacementghost[1]){
            portail[X_TAB]=MAX_LONG;
            portail[Y_TAB]=(MAX_HAUT/2)-TAILLE_TROU;
            if(!portailatteint){
                if((lesX[0]!=portail[X_TAB])&&(lesY[0]!=portail[Y_TAB])){
                    if((direction==HAUT)||(direction==BAS)){ // Si le serpent avance vers la droite ou vers la gauche, il ne peut changer de direction que vers en bas ou vers en haut
                        if(portail[X_TAB]<lesX[0]){ // Si la pomme est à gauche de la tête du serpent, le serpent va à gauche
                            direction=GAUCHE;
                        }else if(portail[X_TAB]>lesX[0]){ // Si la pomme est à droite de la tête du serpent, le serpent va à droite
                            direction=DROITE;
                        }
                    }else if((direction==GAUCHE)||(direction==DROITE)){ // Si le serpent avance vers le bas ou vers le haut, il ne peut changer de direction que vers la droite ou vers la gauche
                        if(portail[Y_TAB]<lesY[0]){ // Quand la pomme et le tête du serpent sont sur la même colonne, si la pomme est au dessus de la tête du serpent, le serpent va en haut
                            direction=HAUT;
                        }else if(portail[Y_TAB]>lesY[0]){ // Quand la pomme et le tête du serpent sont sur la même colonne, si la pomme est en dessous de la tête du serpent, le serpent va en bas
                            direction=BAS;
                        }
                    }
                }else{
        ...
        }else if(ghostfinal==deplacementghost[2]){
            portail[X_TAB]=MIN;
            portail[Y_TAB]=(MAX_HAUT/2)-TAILLE_TROU;
            if(!portailatteint){
                if((lesX[0]!=portail[X_TAB])&&(lesY[0]!=portail[Y_TAB])){
                ...
                if((lesX[0]!=pomme[X_TAB])&&(lesY[0]!=pomme[Y_TAB])){
                    if((direction==HAUT)||(direction==BAS)){ // Si le serpent avance vers la droite ou vers la gauche, il ne peut changer de direction que vers en bas ou vers en haut
                        ...
                        if(pomme[Y_TAB]<lesY[0]){ // Quand la pomme et le tête du serpent sont sur la même colonne, si la pomme est au dessus de la tête du serpent, le serpent va en haut
                            direction=HAUT;
                        }else if(pomme[Y_TAB]>lesY[0]){ // Quand la pomme et la tête du serpent sont sur la même colonne, si la pomme est en dessous de la tête du serpent, le serpent va en bas
                            direction=BAS;
                        }
                    }
                }
            }
        }else if(ghostfinal==deplacementghost[3]){
            portail[X_TAB]=(MAX_LONG/2)-TAILLE_TROU;
            portail[Y_TAB]=MIN;
            if(!portailatteint){
                if((lesX[0]!=portail[X_TAB])&&(lesY[0]!=portail[Y_TAB])){
                    if((direction==HAUT)||(direction==BAS)){ // Si le serpent avance vers la droite ou vers la gauche, il ne peut changer de direction que vers en bas ou vers en haut
                        ...
                        if(portail[Y_TAB]<lesY[0]){ // Quand la pomme et le tête du serpent sont sur la même colonne, si la pomme est au dessus de la tête du serpent, le serpent va en haut
                            direction=HAUT;
                        }else if(portail[Y_TAB]>lesY[0]){ // Quand la pomme et la tête du serpent sont sur la même colonne, si la pomme est en dessous de la tête du serpent, le serpent va en bas
                            direction=BAS;
                        }
                    }
                }else{
        ...
        }else if(ghostfinal==deplacementghost[4]){
            portail[X_TAB]=(MAX_LONG/2)-TAILLE_TROU;
            portail[Y_TAB]=MAX_HAUT;
            if(!portailatteint){
                if((lesX[0]!=portail[X_TAB])&&(lesY[0]!=portail[Y_TAB])){
...
void progresser(int lesX[TAILLE_MAX], int lesY[TAILLE_MAX], char direction, int taille, int destination[2]){
    ...
    if((lesX[0]<MIN) && ((lesY[0]>=((MAX_HAUT/2)-TAILLE_TROU)) && (lesY[0]<=((MAX_HAUT/2))))){ // Vérifier si le serpent a traversé le portail de gauche
        lesX[0]=MAX_LONG;
        portail(lesX,lesY,direction, taille);
    }else if((lesY[0]<MIN) && ((lesX[0]>=((MAX_LONG/2)-TAILLE_TROU)) && (lesX[0]<=((MAX_LONG/2))))){ // Vérifier si le serpent a traversé le portail en haut
        lesY[0]=MAX_HAUT;
        portail(lesX,lesY,direction, taille);
    }else if((lesX[0]>MAX_LONG) && ((lesY[0]>=((MAX_HAUT/2)-TAILLE_TROU)) && (lesY[0]<=((MAX_HAUT/2))))){ // Vérifier si le serpent a traversé le portail de droite
...
void portail(int lesX[TAILLE_MAX], int lesY[TAILLE_MAX], char direction, int taille){
    //copie de l'ancien progresser
}
