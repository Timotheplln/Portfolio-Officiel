/**
* @brief première version de l'automatisation du snake
...
int main(){
    ...
    do{
        ...
        if(pomme[X_TAB]<lesX[0]){ // Si la pomme est à gauche de la tête du serpent, le serpent va à gauche
            ...
            direction=DROITE;
        }else if(pomme[Y_TAB]<lesY[0]){ // Quand la pomme et le tête du serpent sont sur la même colonne, si la pomme est au dessus de la tête du serpent, le serpent va en haut
            direction=HAUT;
